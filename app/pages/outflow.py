import reflex as rx
from app.state import InventoryState, OutflowTransaction


def transaction_row(transaction: OutflowTransaction) -> rx.Component:
    """A single row in the outflow transactions table."""
    return rx.el.tr(
        ...
        rx.el.td(transaction["destination"], class_name="px-6 py-4"),
...
def outflow_page() -> rx.Component:
    """The outflow page displaying all outgoing transactions."""
    return rx.el.div(
        rx.el.div(
            rx.el.h1(
            ...
            rx.el.p(
                "Tracking all outgoing stock and shipments.",
        ...
        rx.el.div(
            summary_card(
                "Total Transactions",
                InventoryState.outflow_transactions.length(),
                "list-ordered",
            ),
            summary_card(
                "Total Quantity Out",
                InventoryState.total_outflow_quantity,
                "package-minus",
            ),
        ...
        rx.el.div(
            rx.el.div(
                ...
                rx.el.input(
                    ...
                    on_change=InventoryState.set_outflow_search,
            ...
            rx.el.table(
                rx.el.thead(
                    rx.el.tr(
                        ...
                        rx.el.th("Destination", class_name="px-6 py-3"),
                ...
                rx.el.tbody(
                    rx.foreach(InventoryState.filtered_outflow, transaction_row)
                ),
